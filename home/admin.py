...
from .models import Beer_Category, Favorite_Beers, Wanted_Beers, Beer_Rating, Beer_Banner, Beer_Note, Beer_Color, Beer_Head, Beer_Attribute_Category, Beer_Attribute_Section, Beer_Attribute, Profile_Sheet
...
admin.site.register(Beer_Color)
admin.site.register(Beer_Head)
